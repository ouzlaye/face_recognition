...
# load our serialize face detector from disk
...
#grab the pathd to the input images in our dataset
print("[INFO] quantifying face...")
imagePaths= list(paths.list_images("dataset"))

#initialize our lists of extracted facial embeddings and corresponding poeple names
knownEmbeddings = []
knownNames = []
